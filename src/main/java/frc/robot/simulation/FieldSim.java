...
public class FieldSim {
  ...
  private final GameHandlerSubsystem m_gph;
  ...
  public FieldSim(DriveSubsystem swerveDrive, GameHandlerSubsystem gph) {
  ...
  private void updateRobotPoses() {
    ...
    m_field2d.getObject("ActiveDrop")
        .setPose(m_gph.getActiveDropPose());
