...
public class DriveSubsystem extends SubsystemBase {
  ...
  public PIDController strafePID = new PIDController(PPConstants.kPStrafeController,
      PPConstants.kIStrafeController, PPConstants.kDStrafeController);
...
public boolean cubeFound;
  ...
  public void tuneStrafePIDGains() {

    if (strafePID.getP() != Pref.getPref("PPStrafekP"))
      strafePID.setP(Pref.getPref("PPstrafekP"));

    if (strafePID.getI() != Pref.getPref("PPStfrafekI"))
      strafePID.setI(Pref.getPref("PPStrafekI"));

    if (strafePID.getD() != Pref.getPref("PPStrafekD"))
      strafePID.setD(Pref.getPref("PPStrafekD"));
