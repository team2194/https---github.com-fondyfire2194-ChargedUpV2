...
public class StrafeToRedFieldY extends PIDCommand {
  /** Creates a new RotateToAngle. */

  public StrafeToRedFieldY(DriveSubsystem drive, GameHandlerSubsystem ghs) {
    super(
        ...
        () -> ghs.getActiveDrop().getRedPose().getY(),
