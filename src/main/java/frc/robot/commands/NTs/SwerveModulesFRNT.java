...
public class SwerveModulesFRNT extends CommandBase {
  ...
  public SwerveModulesFRNT(SwerveModuleSM sm) {
    ...
    NetworkTable swerve = inst.getTable("swerve");
     ...
     NetworkTable frontright = inst.getTable("swerve/frontright");
    
    canokall = frontright.getBooleanTopic("CANOK").publish();

    modulefault = frontright.getBooleanTopic("MODULEFAULT").publish();

    turninposition = frontright.getBooleanTopic("TURNINPOS").publish();

    firmwaredrive = frontright.getStringTopic("FirmwareDrive").publish();

    firmwareturn = frontright.getStringTopic("FirmwareTurn").publish();

    turnangle = frontright.getDoubleTopic("TURNAMPS").publish();
    turnvelocity = frontright.getDoubleTopic("TURNVEL").publish();
    turnout = frontright.getDoubleTopic("TURNOUT").publish();
    turnset = frontright.getDoubleTopic("TURNSET").publish();
    turnamps = frontright.getDoubleTopic("TURNAMPS").publish();

    driveposition = frontright.getDoubleTopic("DRIVEAMPS").publish();
    drivevelocity = frontright.getDoubleTopic("DRIVEVEL").publish();
    driveout = frontright.getDoubleTopic("DRIVEOUT").publish();
    driveset = frontright.getDoubleTopic("DRIVESET").publish();
    driveamps = frontright.getDoubleTopic("DRIVEAMPS").publish();
